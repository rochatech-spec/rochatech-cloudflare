...
# dentro do modal correto, sem atravessar outras telas.
# -----------------------------------------------------------------------------
...
elif new_ios not in i and not ("import re" in i and "funções:" in i):
    raise SystemExit('Helper da organização iOS não encontrado.')
p_ios.write_text(i)

print('Compartilhamento corrigido: Meta limitada ao modal e telas preservadas.')

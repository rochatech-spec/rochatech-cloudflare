...
# rewrite security settings text
...
# auto biometric prompt on lock; still leaves explicit button and password fallback
...
# server: prefer non-discoverable platform credential + internal transport only, reducing hybrid/cross-device prompts

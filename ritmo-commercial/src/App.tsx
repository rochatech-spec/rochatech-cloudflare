...
export default function App() {
  ...
  useEffect(()=>{
    ...
    const posMenu=()=>{const r=fab.getBoundingClientRect(),mr=menu.getBoundingClientRect();let left=innerWidth<=1023?Math.max(12,(innerWidth-mr.width)/2):clamp(r.right-mr.width,12,innerWidth-mr.width-12),top=r.top-mr.height-10;if(top<12)top=clamp(r.bottom+10,12,innerHeight-mr.height-12);menu.style.left=left+'px';menu.style.top=top+'px';};

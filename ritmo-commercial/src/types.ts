export type Transaction = { id: string; date: string; desc: string; cat: string; type: 'Receita' | 'Despesa'; value: number; status: 'pending' | 'posted'; postedAt?: string; icon?: string };

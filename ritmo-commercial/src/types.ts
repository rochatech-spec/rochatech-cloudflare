...
export type Profile = { displayName: string; theme?: 'light'|'dark'|'system'; dueNotifications?: boolean; goalNotifications?: boolean };
export type Bootstrap = { profile: Profile; transactions: Transaction[]; debts: Debt[]; goals: Goal[]; events: EventItem[] };
